...
| [ADR-034](ADR-034.md) | Accepted | 任务与功能归档及父级归档前置校验；角色口径经 ADR-039 修订，**项目归档申请—审核部分由 [ADR-043](ADR-043.md) 替代，模块归档部分由 [ADR-044](ADR-044.md) 替代，功能归档部分由 [ADR-045](ADR-045.md) 替代** |
